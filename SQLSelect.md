...
* [**🖥️ Presentación de los Datos**](./SQLPresentacion.md)
* [**📈 Funciones de Agregación**](./SQLFuncAgregacion.md)
* [**📦 Agrupación**](./SQLAgrupacion.md)
* [**🔗 Relaciones**](./SQLRelaciones.md)
* [**Subconsultas**](./SQLSubconsultas.md)

---
> [!NOTE]
> *Haz clic en cada enlace para navegar a la sección correspondiente.*